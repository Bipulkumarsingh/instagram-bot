...
# get a session!
session = InstaPy(username='instagram_user_name', password='your_password', headless_browser=True)

# let's go! :>
with smart_run(session):
    hashtags = ['python3', 'pythonscript', 'learnjs',
                'codingbootcamp',
                'bootcamp', 'coder', 'coding',
                'codingpic', 'html5',
                'codingproblem', 'linux', 'codingjoke',
                'womenwhocode',
                'programminglife', 'python3', 'java', 'javascript',
                'android',
                'ubuntu', 'webdeveloper', 'machinelearning', 'frontend',
                'backend',
                'datascientist', 'developerlife', 'golang', 'sql',
                'docker',
                'ai', 'internet', 'programmingquote',
                'webdev', 'softwareeengineer',
                'techpeople', 'pythonlearning', 'digitaltransformation',
                'programminghumor', 'worldcode',
                'react', 'angular', 'flask', 'database',
                'github', 'git', 'computerscience','debugging','developer' ]
